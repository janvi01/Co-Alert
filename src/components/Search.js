...
function Search() {
    ...
    const [districtSe, setdistrictSe] = useState("");
    ...
    function handleChangeState(e) {
        setstateSe(e.target.value);
        setstateid(e.target.value);
    }
    function handleChangeDistrict(e) {
        setdistrictSe(e.target.value);
    ...
    return (
        <div className="Search" id={'search'}>
            <VStack justify="center" p={8} pt={16} textAlign="center" spacing="4">
                ...
                <Select placeholder="Select State" value={stateSe} onChange={handleChangeState} variant="filled" w={["90%", "70%", "50%"]}>
                    {states.map((items, key) => {
                        return <option key={key} value={items.state_id}>{items.state_name}</option>
                    })}
                </Select>
                <Select placeholder="Select District" value={districtSe} onChange={handleChangeDistrict} variant="filled" w={["90%", "70%", "50%"]}>
